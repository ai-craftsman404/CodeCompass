 ...
 */
export function getThreatScore(context) {
    const threatMap = {
        none: 0,
        low: 0.2,
        medium: 0.4,
 ...
 */
export function getSizeScore(context) {
    const sizeLines = context.codebaseSizeLines;
    if (!sizeLines)
        return 0;
 ...
 */
export function getResourceScore(context) {
 ...
 */
export function shouldSuggestPhasing(context) {
